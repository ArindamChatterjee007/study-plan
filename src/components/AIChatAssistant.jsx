              ...
              <div className="border-t border-slate-700 bg-slate-800 p-3">
                ...
                <div className="flex flex-wrap gap-2 sm:flex-nowrap">
                  ...
                  <button
                    ...
                    disabled={isSending}
                    className="inline-flex items-center gap-1 rounded-full border border-slate-600 bg-slate-700 px-3 py-2 text-xs font-semibold text-slate-200 hover:bg-slate-600 disabled:cursor-not-allowed disabled:opacity-50"
                  >
                    <svg className="h-3.5 w-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.172 7l-6.586 6.586a2 2 0 102.828 2.828L19 8.828a4 4 0 00-5.656-5.656L5.757 10.76a6 6 0 108.486 8.486L20 13" />
                    </svg>
                  ...
                  {isMemberRecordingVoice ? (
                    <button
                      ...
                      disabled={isSending}
                      className="inline-flex items-center gap-1 rounded-full border border-rose-500 bg-rose-500/20 px-3 py-2 text-xs font-semibold text-rose-200"
                      title="Stop recording"
                    >
                  ...
                  <button
                    ...
                    disabled={isSending}
                    className={`inline-flex items-center gap-1 rounded-full border px-3 py-2 text-xs font-semibold disabled:cursor-not-allowed disabled:opacity-50 ${
                      isMemberPushToTalkActive
                        ? 'border-rose-500 bg-rose-500/20 text-rose-100'
                      ...
                      title="Hold to talk (walkie-talkie)"
                  >
                    <span className={`h-2 w-2 rounded-full ${isMemberPushToTalkActive ? 'bg-rose-300' : 'bg-slate-300'}`} />
                    <svg className="h-3.5 w-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v8m0 0a3 3 0 003-3V7a3 3 0 10-6 0v2a3 3 0 003 3zm5 0v1a5 5 0 01-10 0v-1m5 6v3" />
                    </svg>
                    Push to Talk
                  ...
                  <textarea
                    ...
                    className="min-w-0 flex-1 rounded-xl border border-slate-600 bg-slate-700 px-3 py-2 text-sm text-white placeholder-slate-400 focus:border-violet-500 focus:outline-none resize-none overflow-y-auto max-h-24"
                    disabled={isSending}
                  />
                  <button
                    onClick={sendUserMessage}
                    disabled={(!inputValue.trim() && memberAttachments.length === 0) || isSending}
                    className="rounded-full bg-violet-600 px-4 py-2 text-xs font-semibold text-white transition-colors hover:bg-violet-500 disabled:cursor-not-allowed disabled:bg-slate-600"
                  >
                    Send
                  </button>
                </div>
